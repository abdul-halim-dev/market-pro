                        ...
                        <div className={`list-grid-wrapper ${grid && "list-view"}`}>
...

                                        {
                                            shopProduct.map((item)=>(
                                                <div key={item.id} className="product-card h-100 p-16 border border-gray-100 hover-border-main-600 rounded-16 position-relative transition-2">
                                                <Link
                                                    to={`/product-details-two/${item.id}`}
                                                    className="product-card__thumb flex-center rounded-8 bg-gray-50 position-relative"
                                                > 
                                                    <img src={item.image} alt="This is not ima" className="w-auto max-w-unset"
                                                    />
                                                ...
                                                <div className="product-card__content mt-16">
                                                    ...
                                                    <div className="flex-align mb-20 mt-16 gap-6">
                                                        <span className="text-xs fw-medium text-gray-500">{item.rating.rate} </span>
                                                        <span className="text-15 fw-medium text-warning-600 d-flex">
                                                            <i className="ph-fill ph-star" />
                                                        </span>
                                                        <span className="text-xs fw-medium text-gray-500">{`(${item.rating.count})`} </span>
                                                    </div>
                                                    <div className="mt-8">
                                                        <div
