...
const HotDealsOne = () => {
    ...
    const [hotDealsCards, sethotDealsCards] = useState([]) ;
    ...
    useEffect(()=>{
        ...
        sethotDealsCards(response.data)
            } catch (error) {
                    ...
                    <div className="col-md-8">
                        <div className="hot-deals-slider arrow-style-two">
                            <Slider {...settings}>
                                ...
                                {
                                    hotDealsCards.map((item)=>(
<div>
                                    <div key={item.id} className="product-card h-100 p-8 border border-gray-100 hover-border-main-600 rounded-16 position-relative transition-2">
