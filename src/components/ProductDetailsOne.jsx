...
const ProductDetailsOne = () => {
    ...
    const [mainImage, setMainImage] = useState(singleProduct);
                        ...
                        <div className="row gy-4">
                                        ...
                                        <div className="product-details__images-slider">
                                            <Slider {...settingsThumbs}>
                                                {  
                                                     ...
                                                     <div  className="center max-w-120 max-h-120 h-100 flex-center border border-gray-100 rounded-16 p-8"  onClick={() => setMainImage(singleProduct.image)}>
                                                    <img className='thum' src={ mainImage} alt={`product only `} />
                                                </div>
                            ...
                            <div className="col-xl-6">
                                <div className="product-details__content">
                                    <h5 className="mb-12"> {singleProduct.title} </h5>
                                    <div className="flex-align flex-wrap gap-12">
                                        <div className="flex-align gap-12 flex-wrap">
                                            ...
                                            <span className="text-sm fw-medium text-neutral-600">
                                                 {`${singleProduct.rating?.rate} Star Rating`}   
                                            </span>
