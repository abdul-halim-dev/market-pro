...
useEffect(()=>{
    const productFetch = async ()=>{
        ...
        try {
    const allproeductCard = await axios.get(`https://fakestoreapi.com/products/${productTwoId.productTwo}`)

    const response = allproeductCard.data;
                                    ...
                                    <div className="product-details__thumb-slider border border-gray-100 rounded-16">
                                        <div className="">
                                            <div className="product-details__thumb flex-center h-100">
                                                <img src={productDetailCard.image} alt="Main Product" />
                                            </div>
                                        </div>
                                    </div>
                                    <div className="mt-24">
