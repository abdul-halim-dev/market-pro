...
const BlogDetails = () => {
    ...
    const [ blogDetailsCard, setblogDetailsCard] = useState([]);
    ...
    useEffect(() => {
        const cardsFetch = async () => {
           try {
            ...
            setblogDetailsCard(response.data)
           } catch (error) {
    ...
    useEffect(() => {
        const singleFetch = async () => {
            try {
                const response = await axios.get(`https://fakestoreapi.com/products/${BgID.blogId}`)
               const productCard = response.data;
               setsingleProduct(productCard)
            } catch (error) {
                console.log(error.message)
            }
        }
    ...
    return (
        <section className="blog-details py-80">
            <div className="container container-lg">
                                    ...
                                    <div className="flex-align flex-wrap gap-24">
                                        <div className="flex-align flex-wrap gap-8">
                                            ...
                                            <span className="text-sm text-gray-500">
                                                <Link
                                                    to={`/blog-details/${singleProduct.id}`}
                        ...
                        <div className="my-48 flex-between flex-sm-nowrap flex-wrap gap-24">
                            <div className="">
                                ...
                                <h6 className="text-lg mb-0">
                                    <Link to={`/blog-details/${singleProduct.id}`} className="">
                                        A great commerce experience cannot be distilled to a single
                                        number.{" "}
                                    </Link>
                                </h6>
                ...
                {
                    blogDetailsCard.map((item)=>(
                        <div key={item.id} className="d-flex align-items-center flex-sm-nowrap flex-wrap gap-24 mb-16">
                        <Link
                        ...
                        <div className="blog-sidebar border border-gray-100 rounded-8 p-32 mb-40">
                            ...
                            <ul>
                                ...
                                <li className="mb-0">
                                    <Link
                                        t to={`/blog-details/${singleProduct.id}`}
                                        className="flex-between gap-8 text-gray-700 border border-gray-100 rounded-4 p-4 ps-16 hover-border-main-600 hover-text-main-600"
                                    >
